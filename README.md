...
> - **🌐 Vista en vivo online:** Puedes abrirlo directamente en la web con [HTMLPreview](https://htmlpreview.github.io/?https://github.com/sebatmail/Sistema-de-Gesti-n-Acad-mica--academic-system-django-drf/blob/main/guia_estudio_defensa.html) o en [GitHub Pages](https://sebatmail.github.io/Sistema-de-Gesti-n-Acad-mica--academic-system-django-drf/) sin necesidad de instalar nada.
